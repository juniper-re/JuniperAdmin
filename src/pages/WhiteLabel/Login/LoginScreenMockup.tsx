...
export const LoginScreenMockup: React.FC<IProps> = ({
  image = 'https://app.staging.juniper.re/assets/sign-in.png',
  logo = 'https://app.staging.juniper.re/assets/logo-juniper-color@2x.png'
  ...
  return (
    <div className="mockup-container pointer-events-none flex aspect-video select-none overflow-hidden rounded-lg border border-zinc-100 shadow-lg">
      ...
      <div className="flex basis-1/2 flex-col justify-center gap-3 p-10 ">
        <img className='absolute top-10 self-center' style={{ width: '5vw' }} src={logo} />
      ...
      {/* Right side image */}
      <div className="basis-1/2 bg-cover p-5" style={{ backgroundImage: `url(${image})` }}>
